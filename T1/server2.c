...
/*S2: servidor sequencial fechando conexão a cada requisição: Um único processo/thread aguarda conexão*/
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
#include <errno.h>
...
#define BACKLOG 1   // a quantidade de conexões pendentes a enfileirar
